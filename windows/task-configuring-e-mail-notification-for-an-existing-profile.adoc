...
. 다음 명령을 입력합니다.
+
ssmap profile update -profileprofile [-profile -passwordprofile_password] [-database-dbnamedb_dbname -host db_host [-siddb_sid] [-login-usernamedb_username -password] password [{-rman_subscontentname] durename] [{ -emcountename] subscontentname [-durename]
